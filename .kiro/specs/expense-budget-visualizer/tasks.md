...
- [x] 4. Storage Manager module
  ...
  - [ ]* 4.2 Tulis property test untuk Storage round-trip (Property 4)
  ...
  - [ ]* 4.3 Tulis property test untuk corrupt storage fallback (Property 6)
...
- [x] 5. Validator module
  ...
  - [ ]* 5.2 Tulis property test untuk Validator rejects invalid inputs (Property 1)
...
- [x] 6. Formatter module
  ...
  - [ ]* 6.2 Tulis property test untuk Rupiah formatting (Property 7)
  ...
  - [ ]* 6.3 Tulis property test untuk category color mapping (Property 10)
...
- [x] 7. Core app logic
  ...
  - [ ]* 7.2 Tulis property test untuk valid transaction object creation (Property 2)
  ...
  - [ ]* 7.4 Tulis property test untuk delete removes from storage (Property 5)
  ...
  - [ ]* 7.6 Tulis property test untuk balance equals sum of transactions (Property 8)
...
- [-] 8. Checkpoint — pastikan scaffold, CSS, HTML, Storage, Validator, Formatter, dan core logic terintegrasi
  - Pastikan semua tes yang ditulis sejauh ini lulus; tanyakan ke user jika ada pertanyaan.

- [ ] 9. Chart module
  - [-] 9.1 Implementasi `prepareChartData`
  ...
  - [ ]* 9.2 Tulis property test untuk chart data excludes zero-total categories (Property 9)
  ...
  - [~] 9.3 Implementasi `renderChart` dengan destroy/recreate lifecycle dan CDN fallback
...
- [ ] 10. Event handlers dan init
  - [~] 10.1 Implementasi `handleFormSubmit` dan `handleDeleteTransaction`
  ...
  - [ ]* 10.2 Tulis property test untuk form reset after valid submission (Property 3)
  ...
  - [~] 10.3 Implementasi `init` dengan `DOMContentLoaded`
...
- [ ] 11. CSS polish
  - [~] 11.1 Tambahkan hover/tap states, transitions, dan styles UI pendukung
...
- [~] 12. Checkpoint akhir — pastikan semua tes lulus dan app berfungsi end-to-end
